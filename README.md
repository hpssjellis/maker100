...
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|-----------------|--------|--------|
| <a name="stage2A01" href="#stage2A01">`stage2A01`</a>.           |     LED with resistor on and off. Any Pin --> resistor -->LED --> Ground <br> Like [#5 SOS](https://github.com/hpssjellis/maker100/blob/main/README.md#5) above <br> [dot71-sos.ino](https://github.com/hpssjellis/portenta-pro-community-solutions/blob/main/examples/dot7-coding-curriculum/dot71-sos/dot71-sos.ino
