...
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|-----------------|--------|--------|
| <a name="helium1" href="#helium1">`helium1`</a>.      (All the Helium examples will be in the dot33 location of the arduino Portenta-pro-community-examples libary.)         |      [dot335-helium-http-adafruit-connect.ino](https://github.com/hpssjellis/portenta-pro-community-solutions/blob/main/examples/dot3-portenta-vision-shields/dot33-lorawan-specific/dot335-helium-http-adafruit-connect/dot335-helium-http-adafruit-connect.ino)            |     This is the best most flexible example also shows how to write a decoder          |          |        |        |
