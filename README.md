...
| <a name="community2" href="#community2">`community2`</a>. By @HuffmanLabDU  [CO2 Monitor]()                  |                                                                                                                                                                              |           |                 |        |   Connecct a CO2 monitor perhaps with a GPS device to the Arduino Portenta and perhaps send the information over WiFi or the Helium Network    |
