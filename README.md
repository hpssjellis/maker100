...
| <a name="31" href="#31">`30`</a>.  PCB Board Build (Teacher needs a board to do this)                         |                                                                                                                                                                              |           |                 |        |     Solder surface mount and through hole components on the PCB board and get it running   |
| <a name="32" href="#32">`31`</a>.  [easyEDA](https://easyeda.com/)- either login or download and  [JLCPCB](https://jlcpcb.com/) for Printing it                     |                                                                                                                                                                              |           |                 |        |   Take the edit file from the above PCB build using [easyEDA](https://easyeda.com/) and now edit it ready for printing using [JLCPCB](https://jlcpcb.com/)    |
